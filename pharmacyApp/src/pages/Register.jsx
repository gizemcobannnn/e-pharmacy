  ...
  return (
    <div className="w-full flex flex-row justify-around">
        ...
        <div className="w-[30%] grid grid-cols-2 gap-x-1 gap-y-1">
            <input type="text" placeholder="Username" className="inputUser" /><input type="text" placeholder="Email" className="inputUser" /><input type="text" placeholder="Phone" className="inputUser" /><input type="text" placeholder="Password" className="inputUser"/>
        </div>
    </div>
  )
}
